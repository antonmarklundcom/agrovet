...
return [
    ...
    'services' => [
        ...
        'nexgard' => ['slug' => 'nexgard-comprimido-masticable-perro', 'alt' => 'Perro recibiendo un comprimido masticable antipulgas y antigarrapatas de la mano de su dueño.'],
        'bravecto' => ['slug' => 'bravecto-antiparasitario-perro-patio', 'alt' => 'Perro sano jugando en el patio después de su tratamiento contra pulgas y garrapatas.'],
        'simparica' => ['slug' => 'simparica-perro-revision-pelaje', 'alt' => 'Dueña revisando el pelaje de su perro después de darle su antiparasitario mensual.'],
        'silo-bolsa' => ['slug' => 'silo-bolsa-grano-campo-paraguay', 'alt' => 'Silo bolsa blanco lleno de grano en el borde de un campo cosechado en Paraguay.'],
    ],
    'segmentos' => [
    ...
    'guias' => [
        ...
        'sarna-en-perros' => ['slug' => 'sarna-en-perros-caracha-piel', 'alt' => 'Perro con zonas sin pelo por sarna siendo revisado por una veterinaria.'],
        'sarna-en-gatos' => ['slug' => 'sarna-en-gatos-orejas-revision', 'alt' => 'Gato con costras en las orejas revisado por una veterinaria.'],
        'vacuna-antirrabica' => ['slug' => 'vacuna-antirrabica-perro-veterinario', 'alt' => 'Veterinario aplicando la vacuna antirrábica a un perro tranquilo.'],
        'gusano-barrenador' => ['slug' => 'gusano-barrenador-bichera-revision-ganado', 'alt' => 'Productor revisando heridas en el ganado para prevenir el gusano barrenador.'],
        'levamisol' => ['slug' => 'levamisol-antiparasitario-interno-bovinos', 'alt' => 'Terneros en la manga esperando una dosis de antiparasitario interno.'],
        'cipermetrina' => ['slug' => 'cipermetrina-insecticida-pulverizacion-galpon', 'alt' => 'Aplicación de insecticida con equipo de protección en un galpón de campo.'],
        'fipronil' => ['slug' => 'fipronil-cebo-hormigas-cortadoras', 'alt' => 'Cebo granulado junto a un camino de hormigas cortadoras en la chacra.'],
        'tierra-de-diatomeas' => ['slug' => 'tierra-de-diatomeas-huerta-plantas', 'alt' => 'Tierra de diatomeas espolvoreada sobre las hojas de plantas de la huerta.'],
        'brachiaria-brizantha' => ['slug' => 'brachiaria-brizantha-marandu-pastura', 'alt' => 'Pastura de brachiaria brizantha marandú alta y verde en una estancia de Paraguay.'],
        'gallinas-ponedoras' => ['slug' => 'gallinas-ponedoras-rojas-huevos-nido', 'alt' => 'Gallinas ponedoras rojas junto a un nido con huevos marrones en el gallinero.'],
    ],
];
